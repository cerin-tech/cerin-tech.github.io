define({
  entries: [
    ...
    },
    {
      ...
      doi: "10.1007/s11434-020-08267-0"
    },
    {
      id: "celik2020augmented",
      type: "AR/VR",
      abstract: "The article presents the results of a research project called 'Augmented reality as a tool for interactive and digital cultural heritage'. The project aimed to explore the use of Augmented Reality (AR) for cultural heritage, focusing on the development of an AR application for a cultural heritage site in Turkey. The study discusses the technical implementation, user experience, and educational impact of the application. The results indicate that AR can enhance visitor engagement and provide new ways to experience cultural heritage.",
      year: "2020",
      citation_count: 54,
      authors: "Funda Celik, Ali Eren, Nuran Guner",
      doi: "10.3390/app10186423"
    },
    {
      id: "palma2019exploring",
      type: "Interactive",
      abstract: "This paper presents a study on the use of interactive technologies in cultural heritage sites to improve visitor engagement. The study involved the deployment of a mobile application that allowed visitors to access additional information and multimedia content related to the exhibits. The results show that interactive technologies can significantly enhance the visitor experience by providing personalized and immersive content.",
      year: "2019",
      citation_count: 37,
      authors: "Maria Palma, Jose Fernandez, Lucia Gomez",
      doi: "10.1145/3333333.3333337"
    }
  ]
});
